...
import { BROKERAGE_META_DATA, DUMMY_BROKERAGES } from "@/data/brokerage.data";
import CreateBrokerageModal from "../modal/brokerage/CreateBrokerageModal";
...
const BrokerageList = () => {
  ...
  const meta = BROKERAGE_META_DATA;
